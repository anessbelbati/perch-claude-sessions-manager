...
- **compact mode**: double-click the header (or hit the `–` button) and perch folds into a tiny dynamic-island pill — the bird wearing your **5h limit as a colored ring**, next to colored need-you / working / done counts (`zzz` when everything sleeps). hover it and the island crossfades open to show the chips + limit bars; **click it** and it expands back to the full card. everything still chirps, pulses and flashes — it just takes ~150 pixels doing it
