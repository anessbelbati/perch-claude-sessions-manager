...
- **compact mode**: double-click the header (or hit the `–` button) and perch folds into a tiny dynamic-island pill — the bird wearing your **5h limit as a colored ring**, next to colored need-you / working / done counts (`zzz` when everything sleeps). everything is **click-driven, hover does nothing**: click the pill → the island peeks open (chips + limit bars, closes itself after a few seconds), click the peek → the full card. **drag it and you carry only the bird** — capsule, ring and counts vanish and you're holding a scruff-grabbed birb until you drop him and the pill reassembles
